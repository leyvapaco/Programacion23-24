...
public class NuevoFicheroXMLDesdeCero {
    public static void main(String[] args) {
        ...
        try {
            ...
            asignatura.setAttribute("horas",Integer.toString(programacion.getHorasSemanales()));
            ...
            File nuevoPersonas = new File("C:\\Users\\leyva\\eclipse-workspace\\daw1\\src\\u8\\dom2\\asignaturasXML.xml");
